...
import { cashoutSchema } from '@/lib/validate';
...
export async function POST(req: NextRequest) {
  try {
    ...
    // The actual cashout logic is handled by the game engine via Socket.IO
    // This API just validates and forwards
    return NextResponse.json({ message: 'Cashout handled via real-time socket' });
  } catch (error) {
